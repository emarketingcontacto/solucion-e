...
<header class="sticky top-0 z-[60] w-full bg-gray-950/80 backdrop-blur-md border-b border-white/5">
    <nav x-data="{ open: false }" class="p-6 max-w-7xl mx-auto flex justify-between items-center relative z-[60]">
        ...
        <div class="md:hidden flex items-center">
            <button @click="open = !open" aria-label="Abrir menú de navegación" class="text-brand hover:text-gray-400 focus:outline-none transition-colors">
                ...
                <svg x-show="open" xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none;">
